...
import Select, { ActionMeta, components, OptionsType, OptionTypeBase } from 'react-select';
import styled from '@emotion/styled';
import { rgba } from 'polished';
import { FaChevronDown, FaTimesCircle } from 'react-icons/all';
...
const MultiValueRemove = (props: React.ComponentProps<typeof Styled.MultiValueRemove>) => (
        ...
        <InternalSelect
            ...
            onChange={(value, actionMeta) => {
                if (actionMeta.action === 'select-option') {
                    ...
                    onRemove(value as SelectItem[], actionMeta.removedValue as SelectItem);
                }
            }}
            onClear={onClear}
            clearable={clearable}
